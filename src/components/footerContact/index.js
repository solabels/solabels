      ...
      >
        ...
        <CenteredContent>
          ...
          <Contact>
            ...
            <div className='second-line'>
              <a href={`mailto:${contactInfo.email[0].text}`}>
                {contactInfo.email[0].text}
              </a>
            </div>
          </Contact>
          <Contact>
...
const FooterContact = () => (
  <StaticQuery query={query} render={withPreview(FooterContactCMS, query)} />
);
